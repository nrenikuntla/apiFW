package com.testsuite.dataprovider;
	...
	public class UnitedUnitTests_TestData_Provider {
		...
		//******************************************************** Search ****************************************************
			...
			public static String[][] tc001_searchProducts(){
				...
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator +"United"+fileSeparator +"Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC001_SearchProducts.xlsx");
			...
			public static String[][] tc002_searchProductsByCategory(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator  + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC002_SearchProductsByCategory.xlsx");
			...
			public static String[][] tc003_searchProductsByDuration(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator  + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC003_SearchProductsByDuration.xlsx");
			...
			public static String[][] tc004_searchProductsByAddress(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator +  "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC004_SearchProductsByAddress.xlsx");
			...
			public static String[][] tc005_searchProductsByAddress(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator +"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC005_SearchProductsByAddress.xlsx");
			...
			public static String[][] tc006_queryProductsByPrice(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator  + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC006_QueryProductsByPrice.xlsx");
			...
			public static String[][] tc007_queryProductsByRating(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator +"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC007_QueryProductsByRating.xlsx");
			...
			public static String[][] tc008_queryProductsByReviews(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC008_QueryProductsByReviews.xlsx");
			...
			public static String[][] tc009_queryProductsByTriedandTrue(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC009_QueryProductsByTriedandTrue.xlsx");
			...
			public static String[][] tc010_searchProductsByWebId(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC010_SearchProductsByWebId.xlsx");
				return excel.getExcelSheetData("Sheet1");
			}
			...
			public static String[][] tc011_searchProductsByLatLong(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC011_SearchProductsByLatLong.xlsx");
				return excel.getExcelSheetData("Sheet1");
			}
			...
			public static String[][] tc012_sortProductsByPriceLowHigh(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC012_SortProductsByPriceLowHigh.xlsx");
			...
			public static String[][] tc013_sortProductsByPriceHighLow(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC013_SortProductsByPriceHighLow.xlsx");
			...
			public static String[][] tc014_sortProductsByPopularity(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator +"United"+fileSeparator+ "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC014_SortProductsByPopularity.xlsx");
			...
			public static String[][] tc015_sortProductsByRecommended(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC015_SortProductsByRecommended.xlsx");
			...
			public static String[][] tc016_sortProductsByTopRated(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC016_SortProductsByTopRated.xlsx");
			...
			public static String[][] tc017_sortProductsByPriceLowHighFilteredByPriceRange(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC017_SortProductsByPriceLowHighFilteredByPriceRange.xlsx");
			...
			public static String[][] tc018_sortProductsByPriceHighLowForcedHitsPerPage(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC018_SortProductsByPriceHighLowForcedHitsPerPage.xlsx");
			...
			public static String[][] tc019_sortProductsByPriceHighLowFilteredByLatLong(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC019_SortProductsByPriceHighLowFilteredByLatLong.xlsx");
			...
			public static String[][] tc020_sortProductsByPriceHighLowFilteredByWebId(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC020_SortProductsByPriceHighLowFilteredByWebId.xlsx");
			...
			public static String[][] tc021_sortProductsByPriceLowHighFilteredByWebIdQueryPrice(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator +"United"+fileSeparator+ "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC021_SortProductsByPriceLowHighFilteredByWebIdQueryPrice.xlsx");
			...
			public static String[][] tc025_searchProductsByProductId(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Searches" + fileSeparator + "CreateProductSearch" + fileSeparator + "TC025_SearchProductsByProductId.xlsx");
			...
			public static String[][] TC001_CreateShoppingCart(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Booking" + fileSeparator + "CreateShoppingCart" + fileSeparator + "TC001_CreateShoppingCart.xlsx");
			...
			@DataProvider(name = "TC001_AddBookingOptionsToCart")
			 public static String[][] TC001_AddBookingOptionsToCart(){
			  ...
			  ExcelManager excel = null;
			  excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+ "United"+fileSeparator + "Booking" + fileSeparator + "AddBookingOptionsToCart" + fileSeparator + "TC001_AddBookingOptionsToCart.xlsx");
			...
			public static String[][] TC001_GetBookingQuestions(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator  + "Booking" + fileSeparator + "GetBookingQuestions" + fileSeparator + "TC001_GetBookingQuestions.xlsx");
			...
			public static String[][] TC001_UpdateBookerDetails(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator +"United"+fileSeparator + "Booking" + fileSeparator + "UpdateBookerDetails" + fileSeparator + "TC001_UpdateBookerDetails.xlsx");
			...
			public static String[][] TC001_UpdateBookingAnswers(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator  + "Booking" + fileSeparator + "UpdateBookingAnswers" + fileSeparator + "TC001_UpdateBookingAnswers.xlsx");
			...
			public static String[][] TC001_UpdateTravelerDetails(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator +"United"+fileSeparator + "Booking" + fileSeparator + "UpdateTravelerDetails" + fileSeparator + "TC001_UpdateTravelerDetails.xlsx");
			...
			public static String[][] TC001_ProcessPaymentAndCreateBooking(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator  + "Booking" + fileSeparator + "ProcessPaymentAndCreateBooking" + fileSeparator + "TC001_ProcessPaymentAndCreateBooking.xlsx");
			...
			public static String[][] TC001_ValidateShoppingCart(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator +"United"+fileSeparator + "Booking" + fileSeparator + "ValidateShoppingCart" + fileSeparator + "TC001_ValidateShoppingCart.xlsx");
			...
			public static String[][] TC001_ViewBookingsHistory(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator  + "Booking" + fileSeparator + "ViewBookingsHistory" + fileSeparator + "TC001_ViewBookingsHistory.xlsx");
			...
			public static String[][] TC001_GetSingleBooking(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator  + "Booking" + fileSeparator + "GetSingleBooking" + fileSeparator + "TC001_GetSingleBooking.xlsx");
			...
			public static String[][] TC001_RequestCancelBooking(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator  + "Booking" + fileSeparator + "RequestCancelBooking" + fileSeparator + "TC001_RequestCancelBooking.xlsx");
			...
			public static String[][] TC001_GetVoucherDetails(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator  + "Booking" + fileSeparator + "GetVoucherDetails" + fileSeparator + "TC001_GetVoucherDetails.xlsx");
			...
			public static String[][] TC001_RemoveItemsFromShoppingCart(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator  + "Booking" + fileSeparator + "RemoveItemsFromShoppingCart" + fileSeparator + "TC001_RemoveItemsFromShoppingCart.xlsx");
			...
			public static String[][] TC001_getProductAvailability(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator +"Products" + fileSeparator + "GetProductAvailability" + fileSeparator + "TC001_GetProductAvailability.xlsx");
			...
			public static String[][] TC001_getProductOptions(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator +"United"+fileSeparator+ "Products" + fileSeparator + "GetProductOptions" + fileSeparator + "TC001_GetProductOptions.xlsx");
			...
			public static String[][] TC002_getProductOptions(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Products" + fileSeparator + "GetProductOptions" + fileSeparator + "TC002_GetProductOptions.xlsx");
			...
			public static String[][] TC001_getProductReviews(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator +"United"+fileSeparator+ "Products" + fileSeparator + "GetProductReviews" + fileSeparator + "TC001_GetProductReviews.xlsx");
			...
			public static String[][] TC001_getProductsDetails(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Products" + fileSeparator + "GetProductsDetails" + fileSeparator + "TC001_GetProductDetails.xlsx");
			...
			public static String[][] TC001_getHotelDetails(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Products" + fileSeparator + "GetHotelDetails" + fileSeparator + "TC001_GetHotelDetails.xlsx");
			...
			public static String[][] TC001_getPriceMatch(){
				...
				ExcelManager excel = null;
				excel = new ExcelManager(System.getProperty("user.dir") + fileSeparator + "Data" + fileSeparator + "UnitTests" + fileSeparator+"United"+fileSeparator + "Products" + fileSeparator + "GetPriceMatch" + fileSeparator + "TC001_GetPriceMatch.xlsx");
